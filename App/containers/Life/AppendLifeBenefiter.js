/**
 * Created by dingyiming on 2017/2/1.
 */
...
class AppendLifeBenefiter extends Component{
    ...
    selectBenefiter(benefiter){
        if(this.state.selectedTab==0)
        {
            if(benefiter!==undefined&&benefiter!==null&&
                benefiter.personId!==null&&benefiter.personId!==undefined)
            {
                this.props.setLifeBenefiter(benefiter);
                this.goBack();
            }
        }
    }
    ...
    renderRow(rowData,sectionId,rowId){
        ...
        if(rowData.checked==true){
            this.selectBenefiter(this.state.benefiter);
        }
